                ...
                <div class="nav-header pull-left">
                    <div class="logo-wrap">
                        <a href="{{ route('adm.index') }}">
                            <img class="brand-img" src="{{ asset('admin_theme/img/logo.png') }}" alt="brand"/>
            ...
            <div id="mobile_only_nav" class="mobile-only-nav pull-right">
                <ul class="nav navbar-right top-nav pull-right">
                                ...
                                <ul class="pa-20">
                                    ...
                                    <li class="col-md-6 col-xs-12 preview-carousel">
                                        ...
                                        <div class="product-carousel owl-carousel owl-theme text-center">
                                            ...
                                            <a href="#">
                                                <img src="{{ asset('admin_theme/img/chair2.jpg') }}" alt="chair">
                                                <span>square chair</span>
                                            </a>
                                            <a href="#">
                                                <img src="{{ asset('admin_theme/img/chair3.jpg') }}" alt="chair">
                                                <span>semi circle chair</span>
                                            </a>
                                            <a href="#">
                                                <img src="{{ asset('admin_theme/img/chair4.jpg') }}" alt="chair">
                            ...
                            <li>
                                <div class="streamline message-nicescroll-bar">
                                    ...
                                    <div class="sl-item">
                                        <a href="javascript:void(0)">
                                            <div class="sl-avatar">
                                                <img class="img-responsive" src="{{ asset('admin_theme/img/avatar.jpg') }}" alt="avatar"/>
                                            </div>
                                            <div class="sl-content">
                    ...
                    <li class="dropdown auth-drp">
                        <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="{{ asset('admin_theme/img/user1.png') }}" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
                                                ...
                                                <ul class="chat-list-wrap">
                                                    <li class="chat-list">
                                                        <div class="chat-body">
                                                            <a href="javascript:void(0)">
                                                                <div class="chat-data">
                                                                    <img class="user-img img-circle"  src="{{ asset('admin_theme/img/user.png') }}" alt="user"/>
                                                                    <div class="user-data">
                                                            ...
                                                            <a href="javascript:void(0)">
                                                                <div class="chat-data">
                                                                    <img class="user-img img-circle"  src="{{ asset('admin_theme/img/user1.png') }}" alt="user"/>
                                                                    <div class="user-data">
                                                            ...
                                                            <a href="javascript:void(0)">
                                                                <div class="chat-data">
                                                                    <img class="user-img img-circle"  src="{{ asset('admin_theme/img/user2.png') }}" alt="user"/>
                                                                    <div class="user-data">
                                                            ...
                                                            <a href="javascript:void(0)">
                                                                <div class="chat-data">
                                                                    <img class="user-img img-circle"  src="{{ asset('admin_theme/img/user3.png') }}" alt="user"/>
                                                                    <div class="user-data">
                                    ...
                                    <div class="set-height-wrap">
                                        <div class="streamline message-box nicescroll-bar">
                                            ...
                                            <a href="javascript:void(0)">
                                                <div class="sl-item">
                                                    <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                        <img class="img-responsive img-circle" src="{{ asset('admin_theme/img/user1.png') }}" alt="avatar"/>
                                                    </div>
                                                    <div class="sl-content">
                                            ...
                                            <a href="javascript:void(0)">
                                                <div class="sl-item">
                                                    <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                        <img class="img-responsive img-circle" src="{{ asset('admin_theme/img/user2.png') }}" alt="avatar"/>
                                                    </div>
                                                    <div class="sl-content">
                                            ...
                                            <a href="javascript:void(0)">
                                                <div class="sl-item unread-message">
                                                    <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                        <img class="img-responsive img-circle" src="{{ asset('admin_theme/img/user3.png') }}" alt="avatar"/>
                                                    </div>
                                                    <div class="sl-content">
                                            ...
                                            <a href="javascript:void(0)">
                                                <div class="sl-item unread-message">
                                                    <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                        <img class="img-responsive img-circle" src="{{ asset('admin_theme/img/user4.png') }}" alt="avatar"/>
                                                    </div>
                                                    <div class="sl-content">
